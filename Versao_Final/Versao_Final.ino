...
//Variaveis utilizadas para determinar o estado de execução do controle
uint8_t estado_recepcao_emissao = 0; //0 - Emissão. 1 - Recepção
uint8_t estado_configuracao_recursao = 0; // 0 - Nenhum. 1 - Configuração. 2 - Recursão
...
//Reconfigura o tamanho para armazenar e carregar registros na EEPROM
...
//Responsável por analisar o sinal IR recebido e salva-lo na EEPROM
void recepcao() {
...
//Comando de alterar a temperatura do ar-condicionado
...
//Responsável pelo funcionamento do botões do controle e comando emitidos por eles, emitindo uma resposta ao pressioná-los
...
void setup() {
  ...
  delay(1000);
  if (tempo_para_suspender == 0){
    tempo_para_suspender = 1;
  }
}
